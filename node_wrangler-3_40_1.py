...
class NWPrincipledPreferences(bpy.types.PropertyGroup):
    base_color: StringProperty(
        name='Base Color',
        default='diffuse dif diff alb albedo base col color base_color basecolor',
    ...
    specular: StringProperty(
        name='Specular',
        default='specularity specular spec spc ref',
    ...
    rough: StringProperty(
        name='Roughness',
        default='roughness rou rough rgh',
    ...
    displacement: StringProperty(
        name='Displacement',
        default='displacement displace dis disp dsp height heightmap',
    ...
    ambient_occlusion: StringProperty(
        ...
        default='ao ambient occlusion ambient_occlusion ambientocclusion',
