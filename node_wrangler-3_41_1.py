...
class NWPrincipledPreferences(bpy.types.PropertyGroup):
    base_color: StringProperty(
        name='Base Color',
        default='diffuse dif diff alb albedo base basecolor col color',
    ...
    specular: StringProperty(
        name='Specular',
        default='specularity specular spec spc ref refl',
    ...
    ambient_occlusion: StringProperty(
        ...
        default='ao ambient occlusion ambientocclusion',
